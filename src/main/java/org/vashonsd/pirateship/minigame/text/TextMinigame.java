...
/**
 * @author andy
 * The TextMinigame interface describes the behaviors of anything that can work as a TextMinigame in our world.
 * 
 * Minigames are like processes that run within the main process of the game. Once the Player decides to 
 * Run a minigame, the text commands are now piped into the TextMinigame and consumed there.
 * 
...
public interface TextMinigame {
  /*
   * Run starts up the TextMinigame. It should return a String to announce its starting up; this may
   * be displayed back to the user. This is the only responsibility of this method.
   * 
   * For the example of CrazyChess, the TextMinigame might return "Welcome to CrazyChess! Let's get started!",
