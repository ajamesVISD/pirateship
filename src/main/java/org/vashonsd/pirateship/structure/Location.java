...
/**
 * @author andy A location represents a single place in our world.
 * 
 *         Notice that a location does not "know" how you got there; it does not
 *         know what locations can get to it. It can, through the routes list,
 *         figure out what destinations it can go to.
 */
public class Location extends Actor {
	...
	public void addRoute(String description, String accessor, String splash,
			Location dest) {
	...
	/**
	 * Use this method to add something to a Location. To add a Route, use the
	 * addRoute method.
	 * 
	 * @param a
	 */
